...
const Home = ({ R_count, R_text, R_changeText, R_changeCount, }) => {
  ...
  return (
    <Style.Container>
      <Style.UseBox>
        ...
        <Style.ExplanationParagraph>
          Usos do Redux {useOfRredux}
        </Style.ExplanationParagraph>
        <Style.ReduxParagraph>
          <Style.ReduxContent>redux counter: {R_count}</Style.ReduxContent>
          <Style.ReduxContent>redux text: {R_text}</Style.ReduxContent>
        </Style.ReduxParagraph>
        <Style.ReduxParagraph>
          <Style.ReduxContent>
